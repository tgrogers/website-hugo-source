...
summary: EoSS extracts machine-readable specifications for NVIDIA's undocumented SASS ISA from data embedded in NVIDIA's own tooling, then generates and runs instruction encodings on real hardware. We release validated instruction sets for seven architectures from Volta through Blackwell, making native GPU ISA exploration routine and reproducible.
